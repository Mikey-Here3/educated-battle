...
export const RoomDetailsModal: React.FC<RoomDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-4 backdrop-blur-md">
      <div className="relative w-full max-w-lg max-h-[90vh] flex flex-col rounded-3xl border border-crimson/40 bg-surface-100 shadow-[0_0_50px_rgba(255,0,60,0.3)]">
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between px-5 pt-4 pb-2 bg-surface-100 rounded-t-3xl border-b border-white/5">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-[9px] font-black uppercase text-neon-gold tracking-widest">CUSTOM ROOM CREDENTIALS</span>
